...
SELECT 
 ...
 DECLARE @CustomerTable TABLE (yyyy INT, mm INT, oldcustomer INT,totalcustomer INT,oldpayment decimal(18,2),totalpayment decimal(18,2))
 ...
 while   (@y<=2017)
          ...
          begin
            ...
            If @Count <> 0
			  begin
			     ...
			     INSERT @CustomerTable VALUES (@y, @m, @oldcustomer,@totalcustomer,@oldpayment,@totalpayment)
	...
	select ltrim(str(yyyy)+'-'+ltrim(str(mm))) as Months, 
